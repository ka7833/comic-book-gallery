...
namespace ComicBookGallery.Data
{
    ...
    {
        private static ComicBook[] _comicBooks = new ComicBook[]// array of comic book objects, by making it static we are associating it with the ComicBookRepository class instead of the individual object instances of this class
        {
            new ComicBook()
            {
